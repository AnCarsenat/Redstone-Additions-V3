...
summon item ~ ~ ~ {Item:{id:"minecraft:bat_spawn_egg",count:1,components:{"minecraft:item_model":"minecraft:sculk_sensor","minecraft:item_name":'Entity Detector',"minecraft:custom_data":{ra:{entity_detector:1b}},"minecraft:entity_data":{id:"minecraft:bat",Tags:["ra.spawned","ra.place.entity_detector"],Silent:1b,NoAI:1b,Invulnerable:1b,properties:{range:5,entity_type:"minecraft:pig"}}}},Tags:["ra.drop_temp"]}
