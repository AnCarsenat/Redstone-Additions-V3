# /ra_sensors:blocks/tag_checker/check
# Check for entities with tag in range. As armor stand, at position.
...
# Check using macro
function ra_sensors:blocks/tag_checker/check_macro with storage ra:temp
