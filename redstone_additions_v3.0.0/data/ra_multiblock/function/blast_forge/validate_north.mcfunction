# /ra_multiblock:blast_forge/validate_north
# Validate blast forge structure with hopper to the NORTH of base
# Context: at multiblock base position
# Structure: 3x3x3, hopper at Z-2, furnace at Z-1, base at Z

# Check furnace directly in front (north)
...
data modify storage ra:multiblock facing set value "north"
