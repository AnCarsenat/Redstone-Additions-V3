# /ra_multiblock:blast_forge/validate_east
# Validate blast forge structure with hopper to the EAST of base
# Context: at multiblock base position
# Structure: 3x3x3, hopper at X+2, furnace at X+1, base at X

# Check furnace directly in front (east)
...
data modify storage ra:multiblock facing set value "east"
