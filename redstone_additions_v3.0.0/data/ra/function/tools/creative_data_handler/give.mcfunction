...
give @s minecraft:blaze_rod[item_name="Creative Data Handler",lore=['"Right-click on custom blocks"','"to view and edit properties"'],custom_data={ra:{creative_data_handler:1b}},enchantment_glint_override=true,food={nutrition:0,saturation:0,can_always_eat:true},consumable={consume_seconds:1000000,animation:"none",has_consume_particles:false}]
