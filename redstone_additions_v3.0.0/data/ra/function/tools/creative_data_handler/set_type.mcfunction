...
$tellraw @s [{"text":"/function ra:tools/creative_data_handler/set_property {name:\"$(name)\",value:<new_value>}","color":"white","clickEvent":{"action":"suggest_command","value":"/function ra:tools/creative_data_handler/set_property {name:\"$(name)\",value:}"}}]
