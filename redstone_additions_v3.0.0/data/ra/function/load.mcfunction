...
# Redstone Additions v4.0.2 - Core Load
...
# ========================== WELCOME MESSAGE ==========================
# Load message
tellraw @a [{text:"[RA_Lib] ",color:"gold"},{text:"v4.0.2 loaded",color:"green"}]

# Welcome message
tellraw @a [{text:"[",color:"dark_gray"},{text:"RA",color:"gold",bold:true},{text:"] ",color:"dark_gray"},{text:"Redstone Additions v4.0.2 loaded!",color:"green"}]
