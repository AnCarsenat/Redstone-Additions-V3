...
execute if entity @e[type=armor_stand,tag=ra.custom_block.clock,distance=..0.5,limit=1] run return 0
...
summon item_display ~ ~0.46 ~ {item:{id:"minecraft:clock",count:1},item_display:"fixed",transformation:{left_rotation:[0.7071f,0f,0f,0.7071f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.5f,0.5f,0.5f]},Tags:["ra.custom_block.display_item","ra.custom_block.clock"]}
