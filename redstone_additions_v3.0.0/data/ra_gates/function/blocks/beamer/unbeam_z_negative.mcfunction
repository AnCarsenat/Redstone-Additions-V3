# /ra_gates:blocks/beamer/unbeam_z_negative
# Remove beam in -Z direction
...
execute if score #steps ra.temp matches 1.. positioned ~ ~ ~-1 run function ra_gates:blocks/beamer/unbeam_z_negative
