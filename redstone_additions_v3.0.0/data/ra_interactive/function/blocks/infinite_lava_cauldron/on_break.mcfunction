...
summon item ~ ~ ~ {Item:{id:"minecraft:bat_spawn_egg",count:1,components:{"minecraft:item_model":"cauldron","minecraft:item_name":'Infinite Lava Cauldron',"minecraft:custom_data":{ra:{infinite_lava_cauldron:1b}},"minecraft:entity_data":{id:"minecraft:bat",Tags:["ra.spawned","ra.place.infinite_lava_cauldron"],Silent:1b,NoAI:1b,Invulnerable:1b}}}}
