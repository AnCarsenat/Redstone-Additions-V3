# /ra_interactive:blocks/breeder/breed/pig_beetroot
# Try to breed pigs with beetroot. Positioned at breeder, checking in front.
...
data modify storage ra:temp breed_item set value "beetroot"
