# /ra_interactive:blocks/message_block/tick
# Tick all message_block blocks
...
execute as @e[tag=ra.custom_block.message_block,tag=!ra.was_powered] if score @s ra.power matches 1.. at @s run function ra_interactive:blocks/message_block/send_message_block
