# /ra_interactive:blocks/breeder/breed/pig_potato
# Try to breed pigs with potato. Positioned at breeder, checking in front.
...
data modify storage ra:temp breed_item set value "potato"
