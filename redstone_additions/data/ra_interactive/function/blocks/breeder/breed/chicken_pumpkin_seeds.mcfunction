# /ra_interactive:blocks/breeder/breed/chicken_pumpkin_seeds
# Try to breed chickens with pumpkin seeds. Positioned at breeder, checking in front.
...
data modify storage ra:temp breed_item set value "pumpkin_seeds"
