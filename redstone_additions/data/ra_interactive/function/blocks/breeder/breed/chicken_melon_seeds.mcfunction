# /ra_interactive:blocks/breeder/breed/chicken_melon_seeds
# Try to breed chickens with melon seeds. Positioned at breeder, checking in front.
...
data modify storage ra:temp breed_item set value "melon_seeds"
