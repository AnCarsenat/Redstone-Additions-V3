# /ra_interactive:blocks/breeder/breed/fox_glow_berries
# Try to breed foxes with glow berries. Positioned at breeder, checking in front.
...
data modify storage ra:temp breed_item set value "glow_berries"
