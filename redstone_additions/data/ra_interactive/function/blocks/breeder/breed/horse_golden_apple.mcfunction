# /ra_interactive:blocks/breeder/breed/horse_golden_apple
# Try to breed horses/donkeys with golden apple. Positioned at breeder, checking in front.
...
execute positioned ^ ^ ^1 if entity @e[type=horse,distance=..2,limit=1,nbt={Age:0,Tame:1b}] run data modify storage ra:temp breed_item set value "golden_apple"
...
execute positioned ^ ^ ^1 if entity @e[type=donkey,distance=..2,limit=1,nbt={Age:0,Tame:1b}] run data modify storage ra:temp breed_item set value "golden_apple"
