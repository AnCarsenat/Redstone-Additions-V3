# /ra:tools/data_handler/set_type
...
$tellraw @s [{text:"/function ra:tools/data_handler/set_property {name:\"$(name)\",value:<new_value>}",color:"white",click_event:{action:"suggest_command",command:"/function ra:tools/data_handler/set_property {name:\"$(name)\",value:}"}}]
